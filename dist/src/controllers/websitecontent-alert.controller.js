...
var websiteContentAlert = _sequelize["default"].websiteContentAlert;
var Op = _sequelize["default"].Sequelize.Op;

var websiteContentController = function websiteContentController() {
  var create = /*#__PURE__*/function () {
    var _ref = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee(req, res) {
      var reqObj, errors, websiteContentAlertData, whereCodn;
          ...
          switch (_context.prev = _context.next) {
            ...
            case 12:
              return _context.abrupt("return", res.status(_httpStatus["default"].OK).json({
                ...
                message: _resources["default"].ALERT_REQUIRED
              }));
            ...
            case 13:
              ...
              _context.next = 16;
              return websiteContentAlert.update(reqObj, {
                where: {
                  id: reqObj["id"]
                }
              });
            ...
            case 16:
              websiteContentAlertData = _context.sent;
              _context.next = 27;
              break;

            case 19:
              _context.next = 21;
              return websiteContentAlert.findOne({
                where: whereCodn,
                attributes: {
            ...
            case 21:
              ...
              if (!(websiteContentAlertData && websiteContentAlertData.isNewRecord === false)) {
                _context.next = 24;
                break;
              }
              ...
              return _context.abrupt("return", res.status(_httpStatus["default"].OK).json({
                status: _httpStatus["default"].OK,
                message: _resources["default"].ALERT_ALREADY_EXISTS
              }));

            case 24:
              _context.next = 26;
              return websiteContentAlert.create(reqObj);
  ...
  var getAlert = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
      var errors, reqObj, cond, attributes, _yield$websiteContent, count, websiteContentAlertData;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 4:
              ...
              cond["isActive"] = true;
              _context2.next = 11;
              return websiteContentAlert.findAndCountAll({
                where: cond,
            ...
            case 11:
              ...
              websiteContentAlertData = _yield$websiteContent.rows;
              ...
              return _context2.abrupt("return", res.status(_httpStatus["default"].OK).json({
                status: _httpStatus["default"].OK,
                message: _resources["default"].ALERT_EMPTY
              }));
    ...
    return function getAlert(_x3, _x4) {
  ...
  var deleteAlert = /*#__PURE__*/function () {
        ...
        while (1) {
          switch (_context3.prev = _context3.next) {
            ...
            case 4:
              ...
              _context3.next = 8;
              return websiteContentAlert.update({
                isActive: false
              }, {
                where: {
                  id: reqObj.id
    ...
    return function deleteAlert(_x5, _x6) {
...
//# sourceMappingURL=websitecontent-alert.controller.js.map
