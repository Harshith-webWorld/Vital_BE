...
var zoneController = function zoneController() {
          ...
          switch (_context.prev = _context.next) {
            ...
            case 12:
              return _context.abrupt("return", res.status(_httpStatus["default"].OK).json({
                ...
                message: _resources["default"].ZONE_REQUIRED
              }));
            ...
            case 21:
              ...
              return _context.abrupt("return", res.status(_httpStatus["default"].OK).json({
                status: _httpStatus["default"].OK,
                message: _resources["default"].ZONE_ALREADY_EXISTS
              }));

            case 24:
              _context.next = 26;
              return zones.create(reqObj);
  ...
  var getZone = /*#__PURE__*/function () {
    var _ref2 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2(req, res) {
      var errors, reqObj, cond, attributes, _yield$zones$findAndC, count, zoneData;
      ...
      return _regenerator["default"].wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            ...
            case 11:
              _yield$zones$findAndC = _context2.sent;
              count = _yield$zones$findAndC.count;
              zoneData = _yield$zones$findAndC.rows;
              ...
              return _context2.abrupt("return", res.status(_httpStatus["default"].OK).json({
                status: _httpStatus["default"].OK,
                data: zoneData,
                message: _resources["default"].ZONE_EMPTY
              }));
    ...
    return function getZone(_x3, _x4) {
      return _ref2.apply(this, arguments);
    };
  }();

  var deleteZone = /*#__PURE__*/function () {
    ...
    return function deleteZone(_x5, _x6) {
