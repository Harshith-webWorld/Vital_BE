...
module.exports = function (sequelize, DataTypes) {
  var lymphedemaLineList = sequelize.define("lymphedemaLineList", {
    id: {
  ...
  lymphedemaLineList.associate = function (models) {
    ...
    lymphedemaLineList.hasMany(models.lymphedemaLineListFollowUpsLF, {
      foreignKey: "lymphedemaLineListId",
      as: "LymphedemaLineListFollowUpsLFs",
      allowNull: false,
      constraints: false
    });
    lymphedemaLineList.hasMany(models.lymphedemaLineListFollowUpsHF, {
      foreignKey: "lymphedemaLineListId",
...
//# sourceMappingURL=Lymphedema-LHLineList.model.js.map
